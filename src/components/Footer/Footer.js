    ...
    <footer>
        <Container>
            ...
            <div class="col col-1-5">
                ...
                fugit ducimus! Corrupti ducimus qui labore dolorum voluptatum.
                Vitae, sequi perferendis?
            </div>
            ...
            <hr />
            <div class="row">
            <div class="col col-4-5"><p>© 2022 AddressForAll</p></div>
            <div class="col col-1-5">
                <ul id="sn-icons" class="nav">
                <li>
                    <a href="#"
                    ><svg>
                        <use xlinkHref="#github"></use></svg
                    ></a>
                </li>
                <li>
                    <a href="#"
